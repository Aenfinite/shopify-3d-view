...
export function ModelViewer({
  ...
  if (useModularJacket && modelType === "sample-shirt") {
    const shirtCustomizations: BasicShirtCustomization = {
      ...
      fabricRepeatWidthCm: customizations.fabricRepeatWidthCm,
      fabricRepeatHeightCm: customizations.fabricRepeatHeightCm,
  ...
  if (useModularJacket && modelType === "sample-jacket") {
    const basicCustomizations: BasicJacketCustomization = {
      ...
      liningPbr: customizations.liningPbr,
      liningRepeatX: customizations.liningRepeatX,
      liningRepeatY: customizations.liningRepeatY,
      liningRepeatWidthCm: customizations.liningRepeatWidthCm,
      liningRepeatHeightCm: customizations.liningRepeatHeightCm,
